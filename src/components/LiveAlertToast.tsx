...
export const LiveAlertToast: React.FC<LiveAlertToastProps> = ({
  ...
  return (
    <div
      ...
      className="fixed top-18 right-4 left-4 md:right-8 md:left-auto md:w-[400px] z-50 bg-white border border-emerald-300 rounded-2xl shadow-xl p-3.5 text-slate-800 overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300"
    >
